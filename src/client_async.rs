...
mod tests {
    ...
    fn test_is_valid_orcid_id() {
        // Good
        assert!(AsyncClient::is_valid_orcid_id("0000-0001-5916-0947"));
        assert!(AsyncClient::is_valid_orcid_id("0000000159160947"));

        // Bad
        assert!(!AsyncClient::is_valid_orcid_id(
            "0000-0001-6916-0947" // Wrong digit
        ));
        assert!(!AsyncClient::is_valid_orcid_id(
            "0000-0001-5916-0948" // Wrong checksum
        ));
        assert!(!AsyncClient::is_valid_orcid_id("12345"));
        assert!(!AsyncClient::is_valid_orcid_id("xyz"));
    }
    ...
    fn test_debug() {
        ...
        assert!(debug_str.contains("AsyncClient"));
    ...
    fn test_valid_orcid_with_x() {
        assert!(AsyncClient::is_valid_orcid_id("0000-0002-1825-0097"));
        assert!(AsyncClient::is_valid_orcid_id("0000000218250097"));
    }

    #[test]
    fn test_invalid_orcid_length() {
        assert!(!AsyncClient::is_valid_orcid_id("0000-0001-5916"));
        assert!(!AsyncClient::is_valid_orcid_id("0000-0001-5916-0947-1234"));
        assert!(!AsyncClient::is_valid_orcid_id(""));
    }

    #[test]
    fn test_invalid_orcid_chars() {
        assert!(!AsyncClient::is_valid_orcid_id("0000-0001-5916-094A"));
        assert!(!AsyncClient::is_valid_orcid_id("0000-0001-5916-094?"));
        assert!(!AsyncClient::is_valid_orcid_id("ABCD-EFGH-IJKL-MNOP"));
    }
